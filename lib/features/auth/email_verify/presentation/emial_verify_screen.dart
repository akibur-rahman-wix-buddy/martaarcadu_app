...
class EmialVerifyScreen extends StatefulWidget {
  const EmialVerifyScreen({super.key});

  @override
  State<EmialVerifyScreen> createState() => _EmialVerifyScreenState();
}

class _EmialVerifyScreenState extends State<EmialVerifyScreen> {
